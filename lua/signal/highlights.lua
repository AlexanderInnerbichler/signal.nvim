...
local function apply()
  ...
  vim.api.nvim_set_hl(0, "SignalReceiptSent",   { fg = "#3d4350",              bg = "NONE" })
  vim.api.nvim_set_hl(0, "SignalReceiptRead",   { fg = "#61afef",              bg = "NONE" })
  vim.api.nvim_set_hl(0, "SignalTimeHot",       { fg = "#5faf5f",              bg = "NONE" })
  vim.api.nvim_set_hl(0, "SignalTimeWarm",      { fg = "#c4973a",              bg = "NONE" })
  vim.api.nvim_set_hl(0, "SignalStripeContact", { fg = "#3d6e9e",              bg = "NONE" })
  vim.api.nvim_set_hl(0, "SignalStripeGroup",   { fg = "#7d4e9e",              bg = "NONE" })
  vim.api.nvim_set_hl(0, "SignalStripePinned",  { fg = "#9e7e2e",              bg = "NONE" })
